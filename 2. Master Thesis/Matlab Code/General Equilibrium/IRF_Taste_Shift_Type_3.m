...
% 1
pct = 0.1;
permanent_shock = evrnd(0, 0.3, 1, 400);
for i=60:T
    phi_mat(i, :) = permanent_shock;
end
...
Cdev = ((C - C(50))/C(50))*100;
Kdev = ((K - K(50))/K(50))*100;
rdev = ((r - r(50))/r(50))*100;
w1dev = ((w1 - w1(50))/w1(50))*100;
w2dev = ((w2 - w2(50))/w2(50))*100;

m11dev = ((m11 - m11(50))/m11(50))*100;
m12dev = ((m12 - m12(50))/m12(50))*100;
m21dev = ((m21 - m21(50))/m21(50))*100;
m22dev = ((m22 - m22(50))/m22(50))*100;

L1dev = ((L1 - L1(50))/L1(50))*100;
L2dev = ((L2 - L2(50))/L2(50))*100;

Ydev = ((Y - Y(50))/Y(50))*100;

Idev = ((I - I(50))/I(50))*100;
